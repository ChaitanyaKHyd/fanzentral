...
class Feed {
	...
	public function editFeed($body, $id, $user_from, $user_to){
		...
		$check_empty = preg_replace('/\s+/', '', $body); //Deletes all spaces
			...
			$query = mysqli_query($this->con, "UPDATE feed SET body='$body' WHERE id='$id'");
			...
			if($user_to!= 'none'){
				...
				$notification = new Notification($this->con, $user_from);

				$notification->insertNotification($id, $user_to, "edit_profile_post");
	...
	public function loadPostsFriends($data, $limit){ 
		...
		$data_query = mysqli_query($this->con,"SELECT * FROM feed WHERE deleted='no' ORDER BY id DESC");
	...
	public function loadProfilePosts($data, $limit){
		...
		$data_query = mysqli_query($this->con,"SELECT * FROM feed WHERE deleted='no' AND ((added_by='$profileUser' AND user_to='none')OR user_to='$profileUser') ORDER BY id DESC");
			...
			while($row = mysqli_fetch_array($data_query)){
				...
				$str .= "<div class='status_post'>
							...
							<div class='posted_by' style='color:#000000;'>
								...
								<a href='$added_by'>$first_name $last_name</a>&nbsp;&nbsp;&nbsp;&nbsp;$time_message<br>
	...
	public function getSinglePost($post_id){
		...
		$data_query = mysqli_query($this->con,"SELECT * FROM feed WHERE deleted='no' AND id='$post_id'");

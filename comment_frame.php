...
$user_query = mysqli_query($con, "SELECT added_by, user_to FROM feed WHERE id='$post_id'");
...
if(isset($_POST['postComment'.$post_id])){
	...
	$insert_post=mysqli_query($con, "INSERT INTO comments VALUES ('','$post_body','$userLoggedIn','$
